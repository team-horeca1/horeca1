...
const VENDOR_MODULES = ['dashboard', 'products', 'brandMappings', 'priceLists', 'orders', 'returns', 'inventory', 'grn', 'dispatch', 'deliveries', 'wallet', 'ledger', 'creditLine', 'customers', 'users', 'outlets', 'analytics', 'promotions', 'salespersons', 'commissions', 'notifications', 'settings'] as const;
...
const ROLE_TEMPLATES: Array<{
  ...
  { name: 'Order Manager', scope: 'vendor', description: 'Order processing', permissions: perms({ dashboard: ['view'], orders: ['view', 'edit', 'approve'], returns: ['view', 'edit', 'approve'], dispatch: ['view', 'create', 'edit'], deliveries: ['view', 'edit'], grn: ['view'], inventory: ['view'] }) },
