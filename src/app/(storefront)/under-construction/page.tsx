        ...
        <div className="flex-1 min-h-[70vh] flex items-center justify-center p-6 py-20 bg-[#F7F8FA]">
            <div className="max-w-[600px] w-full bg-white rounded-[40px] p-8 md:p-16 text-center shadow-[0_20px_60px_rgba(0,0,0,0.05)] border border-gray-100 relative overflow-hidden">
                ...
                <div className="relative z-10">
                    {/* Icon Container */}
                    <div className="w-24 h-24 md:w-32 md:h-32 bg-primary-light rounded-full flex items-center justify-center mx-auto mb-8 animate-pulse">
                        <Construction size={48} className="text-primary md:size-[64px]" />
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-8">
                        <Link
                            href="/"
                            className="flex items-center gap-2 px-8 py-4 bg-primary text-white rounded-2xl font-bold hover:bg-primary-dark transition-all shadow-lg shadow-primary/20 active:scale-95 w-full sm:w-auto"
                        >
                            <Home size={20} />
                            Back to Home
                        </Link>
