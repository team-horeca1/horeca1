        ...
        <div className="bg-white rounded-xl border border-gray-100 p-4 sm:p-5">
          <div className="flex items-start justify-between gap-3 mb-3">
            <div className="min-w-0">
              ...
              <button
                ...
                className="font-mono text-[15px] font-bold text-[#181725] hover:text-primary cursor-pointer"
              >
                {data.trackingKey}
              </button>
            ...
            <span className={cn(
              ...
              data.status === 'paid' ? 'bg-success-light text-primary'
          ...
          {data.claimUrl && (
            <div className="mb-3 flex items-center gap-2">
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 min-w-0 rounded-md border border-gray-200 px-2 py-1 text-[11px] font-bold text-[#181725] hover:border-primary cursor-pointer"
                title={data.claimUrl}
              >
          ...
          {data.status === 'approved' && data.entryId && (
            <button
              ...
              className="mt-4 w-full py-2.5 rounded-xl bg-primary text-white text-[13px] font-bold hover:bg-primary-dark disabled:opacity-50 cursor-pointer"
            >
              Mark Paid
            </button>
          )}
