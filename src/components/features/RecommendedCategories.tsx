...
const ProductCard = ({ product }: { product: Product }) => (
    <div className="bg-white border border-gray-200 rounded-[16px] p-3 md:p-5 flex flex-col relative group transition-all duration-300 hover:shadow-md h-full">
        ...
        <div className="mt-auto">
            ...
            <button className="w-full py-2 bg-primary-light hover:bg-primary hover:text-white rounded-full flex items-center justify-center gap-1.5 text-primary text-[11px] md:text-[13px] font-bold transition-all active:scale-95">
                Add To Cart
